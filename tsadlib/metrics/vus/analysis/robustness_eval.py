...
def compute_anomaly_acc_lag(methods_scores, label, slidingWindow, methods_keys):
    ...
    for i, methods_score in enumerate(tqdm(methods_keys)):
        ...
        for lag in tqdm(lag_range):
            ...
            R_AUC, R_AP, R_fpr, R_tpr, R_prec = grader.RangeAUC(labels=new_label, score=methods_scores[methods_score],
            ...
            Y, Z, X, X_ap, W, Z_ap, avg_auc_3d, avg_ap_3d = generate_curve(new_label, methods_scores[methods_score],
                                                                           2 * slidingWindow)
...
def compute_anomaly_acc_percentage(methods_scores, label, slidingWindow, methods_keys, pos_first_anom):
    ...
    for i, methods_score in enumerate(tqdm(methods_keys)):
        ...
        for end_pos in tqdm(list_pos):
            ...
            R_AUC, R_AP, R_fpr, R_tpr, R_prec = grader.RangeAUC(labels=new_label, score=new_score, window=slidingWindow,
                                                                plot_ROC=True)
